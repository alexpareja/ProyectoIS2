...
inventario.add(productos);
    ...
    ctrl.iniciarSesion("Patrizia","betaCero");
    ...
    while (desp != 'S') {
      ...
      if (desp == 'I' || desp == 'i') {
        ...
        if(productoCarrito>=1 && productoCarrito<=inventario.getProductos().size())
        {
          carrito.anadirCarrito(inventario.buscarProductoPosicion(productoCarrito-1));
        }
        else {
