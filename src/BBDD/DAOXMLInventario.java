		...
		try {
			...
			for (int i = 0; i < nList.getLength(); i++) {
				...
				case "camiseta":
					...
					p = new DTOInventario(e.getAttribute("id"), precio, publicado, stock, udsVendidas, reservados,
							talla, n, dorsal);
					a.add(p);
					break;
				case "pantalon":
				...
				case "conjunto":
					...
					p = new DTOInventario(e.getAttribute("id"), precio, publicado, stock, udsVendidas, reservados,
							tallaConjunto, nConjunto, dorsalConjunto);
					a.add(p);
					break;
				case "guantes":
					...
					p = new DTOInventario(e.getAttribute("id"), precio, publicado, stock, udsVendidas, reservados,
							tallaGuantes, modeloG, marcaG, colorG, adherencia);
					a.add(p);
					break;
				}
			}
