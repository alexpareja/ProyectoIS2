...
public class ControlPanel extends JPanel implements InventarioObserver, UsuariosObserver {
	...
	private void initGUI() {
		...
		Busuario.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// Se pide el usuario y la contrase�a
		...
		Bcarrito.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (int j = 0; j < modelo.getRowCount(); j++)
					modelo.removeRow(j);
				// Se muestran los acticulos del array del carrito con su inforacio�n y el total
				// de la compra
		...
		// Se muestra la informaci�n del usuario actual
